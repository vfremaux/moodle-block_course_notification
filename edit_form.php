...
class block_course_notification_edit_form extends block_edit_form {
    ...
    function specific_definition($mform) {
        ...
        $mform->setAdvanced('config_firstassign_object_ovl');
        ...
        $mform->setAdvanced('config_firstcall_object_ovl');
        ...
        $mform->setAdvanced('config_secondcall_object_ovl');
        ...
        $mform->setAdvanced('config_twoweeksnearend_object_ovl');
        ...
        $mform->setAdvanced('config_oneweeknearend_object_ovl');
        ...
        $mform->setAdvanced('config_fivedaystoend_object_ovl');
        ...
        $mform->setAdvanced('config_threedaystoend_object_ovl');
        ...
        $mform->setAdvanced('config_onedaytoend_object_ovl');
        ...
        $mform->setAdvanced('config_closed_object_ovl');
        ...
        $mform->setAdvanced('config_completed_object_ovl');
        ...
        $mform->setAdvanced('config_inactive_object_ovl');
