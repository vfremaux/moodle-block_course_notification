...
$string['configfirstcalldelay'] = 'Delai (en jours) pour le premier rappel après inscription';
...
$string['configsecondcalldelay'] = 'Delai (en jours) pour le deuxième rappel après inscription';
...
$string['delayfromstart'] = '{$a} jours du début';
...
$string['configdefaultfirstcalldelay'] = 'Délai de premier rappel après inscription (défaut)';
$string['configdefaultsecondcall'] = 'Second rappel après inscription (défaut)';
$string['configdefaultsecondcalldelay'] = 'Délai de deuxième rappel après inscription (défaut)';
...
$string['configoneweekfromstart'] = 'Si activé, une notification est envoyée en début de période de formation, si aucune activité dans le cours n\'a été détectée au bout de quelques jours';
$string['configtwoweeksfromstart'] = 'Si activé, une notification est envoyée en début de période de formation, si aucune activité dans le cours n\'a été détectée au bout d\'une durée plus longue';
$string['configoneweekfromend'] = 'Si activé, une notification est envoyée à tout utilisateur dont l\'inscription prend fin une semaine plus tard';
$string['configtwoweeksfromend'] = 'Si activé, une notification est envoyée à tout utilisateur dont l\'inscription prend fin deux semaines plus tard';
