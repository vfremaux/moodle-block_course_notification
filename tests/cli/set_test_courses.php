...
if ($options['help']) {
    $help = "
Add an instance of the course_notification block in all courses.
...
Example:
\$sudo -u www-data /usr/bin/php blocks/course_notification/tests/cli/set_test_courses.php [--host=<wwwroot>]
";
